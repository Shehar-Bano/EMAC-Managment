<x-website.layout :title="'Terms and Conditions — EMAC Development, LLC.'">
    <section class="py-12 lg:py-16 bg-gradient-to-b from-[#FAF8F4] to-white border-b border-slate-200/80">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="text-xs font-bold uppercase tracking-widest text-[#8F6B20]">Contractual Terms</span>
            <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-2">{{ $document->title ?? 'Terms and Conditions' }}</h1>
            <p class="text-xs text-slate-500 mt-2">
                Effective Date: {{ $document->effective_date?->format('F d, Y') ?? 'September 2026' }} • Version {{ $document->version ?? '1.0' }} • EMAC Development, LLC.
            </p>
        </div>
    </section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-white p-8 sm:p-12 rounded-3xl border border-slate-200/90 shadow-xs space-y-6 text-xs sm:text-sm text-slate-700 leading-relaxed">
            ...
            @else
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-900 mb-2">1. Agreement to Terms</h2>
                ...
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-900 mb-2">2. Architectural House Plans & Intellectual Property</h2>
                    <p class="mb-2">All stock house plans, blueprints, 3D renderings, and schematic illustrations provided by EMAC Development are proprietary intellectual property:</p>
                ...
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-900 mb-2">3. Contracting, Estimates & Service Execution</h2>
                    <ul class="list-disc pl-5 space-y-1 text-slate-600">
                ...
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-900 mb-2">4. Handyman & Property Maintenance Subscriptions</h2>
                ...
                <div>
                    <h2 class="text-base sm:text-lg font-bold text-slate-900 mb-2">5. Governing Law & Jurisdiction</h2>
