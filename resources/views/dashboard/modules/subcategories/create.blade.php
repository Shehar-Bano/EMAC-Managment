<x-dashboard.layout :title="'Create Subcategory — EMAC Development ERP'">
    ...
    <div class="max-w-4xl">
        <form method="POST" action="{{ route('dashboard.subcategories.store') }}" enctype="multipart/form-data" class="space-y-6" x-data="{
            ...
            <x-card title="Subcategory Details & Visual Image" subtitle="Classification parameters, visual image and parent category mapping">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-5">
                        ...
                        <div class="flex-1 w-full">
                            <div class="relative border-2 border-dashed border-slate-300 hover:border-[#C5A059] rounded-xl p-4 transition-colors bg-white/80 hover:bg-white text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-3">
                                <div>
                                    <p class="text-xs font-semibold text-slate-800" x-text="fileName ? 'Selected: ' + fileName : 'Select a trade or service icon image'"></p>
                                ...
                                <label for="subcategory-image-input" class="shrink-0 px-4 py-2 rounded-lg bg-gradient-to-r from-[#C5A059] to-[#D4AF37] hover:from-[#B8903B] hover:to-[#C5A059] text-slate-950 font-bold text-xs shadow-xs hover:shadow transition-all cursor-pointer inline-flex items-center gap-2">
