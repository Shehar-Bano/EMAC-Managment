...
<span class="inline-flex items-center justify-center shrink-0 {{ $class }}">
    @switch($name)
        @case('architecture')
        @case('blueprint')
        ...
        @case('hammer')
            <svg class="{{ $sizeClasses }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2v16z" />
            </svg>
            @break
